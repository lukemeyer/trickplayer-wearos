...
import com.lukemeyer.trickplayer.data.EpisodeRepository
...
object SceneState {
    ...
    fun advance(ctx: Context, force: Boolean, mode: Advance = Advance.NEXT_SUBTITLE): Boolean {
        ...
        // Autoplay is not a single advance: it is a burst, built by
        // [SceneTimeline]. Reaching here with it means a caller took the wrong
        // branch.
        require(mode != Advance.AUTOPLAY) { "autoplay is built by SceneTimeline, not advanced" }
