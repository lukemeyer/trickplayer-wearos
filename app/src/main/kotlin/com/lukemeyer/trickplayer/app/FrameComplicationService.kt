...
/**
 * Supplies the scene's frame as a PHOTO_IMAGE complication.
 *
 ...
 *
 * The image goes across as `Icon.createWithData` over the **source's own JPEG**,
...
class FrameComplicationService : ComplicationDataSourceService() {
    ...
    override fun getPreviewData(type: ComplicationType): ComplicationData? {
        ...
        return PhotoImageComplicationData.Builder(
            ...
            contentDescription = PlainComplicationText.Builder("Scene frame").build(),
        ).build()
    }

    private fun build(entry: com.lukemeyer.trickplayer.data.SceneCache.Entry): ComplicationData =
    ...
    companion object { private const val TAG = "TpFrame" }
}
