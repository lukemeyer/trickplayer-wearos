 ...
 * was.
 *
 *     adb shell am broadcast -a com.lukemeyer.trickplayer.app.CONFIGURE \
...
class ConfigReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION = "com.lukemeyer.trickplayer.app.CONFIGURE"
        private const val TAG = "TpConfig"
    }
}
