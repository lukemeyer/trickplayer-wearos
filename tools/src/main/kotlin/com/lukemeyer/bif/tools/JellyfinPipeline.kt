 ...
 * [com.lukemeyer.bif.data.AndroidSheetCropper]; everything above that is the
 * code that ships.
 *
...
fun main() {
    ...
    var found: Pair<BrowseItem, com.lukemeyer.bif.core.source.Playable>? = null
    for (root in roots) {
...
): Pair<BrowseItem, com.lukemeyer.bif.core.source.Playable>? {
    for (i in items) {
